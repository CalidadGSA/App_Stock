  ...
  return (
    <div className="mx-auto max-w-lg">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Nuevo control de vencimientos</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Registrá fechas de vencimiento por producto</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-gray-900 dark:text-gray-100">Control de vencimientos</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">Podés cargar múltiples fechas por producto</p>
            </div>
          </div>
        </CardHeader>
        <CardContent>
