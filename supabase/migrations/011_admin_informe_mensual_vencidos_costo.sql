-- Valor en dinero de vencidos cargados en el mes (cantidad × costo medicamento).
...
comment on function public.admin_estadisticas_mensual_sucursal(timestamptz, timestamptz) is
  'Agregados por sucursal: inventariados, vencidos cargados y su costo (cantidad×costo), unidades vendidas, líneas con diferencia.';
